  ...
  Format.FORMATS = {
    ...
    link: {
      ...
      add: function(node, value) {
        var InAppBrowser_link = "window.open\(\'" + value + "\', \'_blank\', \'location=yes\'\)\; return false;";
        // custom insert link tool for cordova
        node.setAttribute('href', value );
        node.setAttribute('id', 'InAppBrowser_link');
        // node.setAttribute('onclick', 'function(e)');
        node.setAttribute('onclick', InAppBrowser_link);
        return node;
      },
...
LinkTooltip = (function(superClass) {
  ...
  LinkTooltip.prototype._normalizeURL = function(url) {
    if (!/^(https?:\/\/|mailto:)/.test(url)) {
      url = 'https://' + url;
      // url = 'onclick="window.open(&#39;' + url + '&#39;, &#39;_system&#39;, &#39;location=yes&#39;); return false;"';
    }
    return url;
  };
